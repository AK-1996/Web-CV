...
function read() {
    respContainer = document.getElementsByClassName("response")[0];
...
function dark_light(){
    ...
    const booking_container = document.getElementsByClassName("booking_container")[0];
    ...
    if (body.style.backgroundColor === "white"){
        ...
        form_container.style.backgroundColor = "#505050";
        form_container.style.color = "white";
        booking_container.style.backgroundColor = "#505050";
        booking_container.style.color = "white";
    } else {
        //Light mode
        ...
        form_container.style.backgroundColor = "#f2f2f2";
        form_container.style.color = "black";
        booking_container.style.backgroundColor = "#f2f2f2";
        booking_container.style.color = "black";
    }
}